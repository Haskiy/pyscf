...
def _gen_uhf_response_sf(mf, mo_coeff=None, mo_occ=None, hermi=0,extype=0,\
    ...
    def vind(dm1):
        in2 = numint.NumInt()
        v1 = in2.nr_uks_fxc_sf(mol, mf.grids, mf.xc, dm0, dm1, 0, hermi,
...
def _gen_uhf_tda_response_sf(mf, mo_coeff=None, mo_occ=None, hermi=0,\
    ...
    def vind(dm1):
        in2 = numint.NumInt()
        v1 = in2.nr_uks_fxc_sf_tda(mol, mf.grids, mf.xc, dm0, dm1, 0, hermi,
...
uhf.UHF.gen_response_sf = _gen_uhf_response_sf
uhf.UHF.gen_tda_response_sf = _gen_uhf_tda_response_sf